...
from .config import MAX_SUMMARY_CHARS, MAX_TOKENS, TEMPERATURE, TOP_P
...
class WriterAgent(BaseAgent):
    ...
    def _extract_context(self, state: Dict[str, Any]) -> WriterContext:
        ...
        # The un-suffixed keys are the Writer's standalone input contract.
        # The ``*_result`` fallbacks keep it compatible with the current
        # Orchestration state while upstream Agents are being integrated.
