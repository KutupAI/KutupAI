...
class OCRConfig:
    ...
    device: str = "gpu"  # gpu | gpu:N | auto | cpu — layer prefers GPU
    ...
    # Off by default: avoids PP-LCNet / Structure companion stacks (speed).
    enable_doc_orientation: bool = False
    enable_doc_unwarping: bool = False
    ...
    def from_env(cls) -> "OCRConfig":
        ...
        return cls(
            ...
            max_ocr_attempts=int(os.getenv("OCR_MAX_ATTEMPTS", "2")),
            ...
            enable_doc_orientation=boolean("OCR_DOC_ORIENTATION", False),
            enable_doc_unwarping=boolean("OCR_DOC_UNWARPING", False),
            enable_textline_orientation=boolean("OCR_TEXTLINE_ORIENTATION", False),
            enable_seal_recognition=boolean("OCR_SEAL_RECOGNITION", False),
